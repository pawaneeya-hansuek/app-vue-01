<template>
  <div class="container mt-4">
    ...
    <div class="mb-3">
      <button class="btn btn-primary" @click="openAddModal"><i class="bi bi-plus"></i>Add</button>
    </div>
      ...
      <tbody>
        <tr v-for="product in products" :key="product.product_id">
          ...
          <td>
            <img
              v-if="product.image"
              :src="'http://localhost/app-vue-01/php_api/uploads/' + product.image"
              width="100"
            />
          </td>
          <td>
  ...
  <div v-if="isEditMode && editForm.image">
    ...
    <img
      :src="'http://localhost/app-vue-01/php_api/uploads/' + editForm.image"
      width="100"
    />
  </div>
</div>
...
export default {
  ...
  setup() {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://localhost/app-vue-01/php_api/api_product.php");
  ...
  try {
    const res = await fetch(
      "http://localhost/app-vue-01/php_api/api_product.php?type=categories"
    );
